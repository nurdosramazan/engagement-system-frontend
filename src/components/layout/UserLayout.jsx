    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="bg-white shadow-md p-4 flex justify-between items-center">
          <div></div> {/* This empty div pushes the other items to the right */}
          <div className="flex items-center space-x-4">
            {/* Conditionally render the Admin Panel button */}
            {isAdmin && (
              <Link
                to="/admin/dashboard"
                className="flex items-center px-4 py-2 bg-gray-700 text-white rounded-lg hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors"
              >
                <AdminIcon />
                Admin Panel
              </Link>

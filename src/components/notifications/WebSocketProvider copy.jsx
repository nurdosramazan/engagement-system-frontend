          ...
          try {
            ...
            if (notificationSound) {
              notificationSound.play().catch(error => {
                console.warn("[WebSocketProvider] Sound playback failed:", error);
              });
            }
            ...
            if (notification.eventType?.includes('APPOINTMENT') || lowerCaseMessage.includes('appointment') || lowerCaseMessage.includes('application')) {
